...
class GnsController:
    ...
    def _async_send(self, channel, recipient: str, subject: str, template_name: str, data: dict, notification_id: str):
    ...
    def send_notification(self, channel_name: str, recipient: str, subject: str, template_name: str, data: dict, sync: bool = False) -> str:
        ...
        if not channel:
            ...
            raise ValueError(f"Channel '{channel_name}' is not supported. Available: {list(self.channels.keys())}")
